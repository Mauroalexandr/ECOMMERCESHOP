...
<link
  rel="stylesheet"
  href="plugins/css/cdb.css" />
<script
  src=".plugins/js/cdb.js"></script>
<script
  src="plugins/js/bootstrap.min.js"></script>
		...
		<div class="container">
				...
				<div class="row">
					...
					<div class="col-sm-5 clearfix">
						<div class="bill-to">
							<p>Bill To</p>
							<div class="form-one">
								<form action="app/addCheckout.php" method="POST">
									<input name="pais" type="text" placeholder="Pais">	
									<input name="nempresa" type="text" placeholder="Nome da empresa">
									<input name="email" type="text" placeholder="Email*">
									<input name="pnome" type="text" placeholder="Primeiro Nome *">
									<input name="unome" type="text" placeholder="Ultimo nome *">
									...
									<input name="condado" type="text" placeholder="Estado/País">
									<input name="telefone" type="text" placeholder="Telefone">
									<div class="form-row place-order">

									<div class="form-group">
    								<label for="exampleFormControlFile1">Adiocionar Comprovativo</label>
  									  <input type="file" class="form-control-file" name="ficheiro" id="exampleFormControlFile1" required >
 										 </div>
									<button class="btn btn-primary" type="submit">Encomendar</button>
									</div>
			...
			<div class="table-responsive cart_info">
				<table class="table table-condensed">
					 ...
					 if(count($_SESSION['carrinho']) == 0){
						...
						$total_final = 0;
						 ...
						 <td class='cart_product'>
							 <a href=''><img style='width:80px;' src='upload_img/".$data['imagem'].".jpg' alt=''></a>
						 </td>
						 ...
						 <td class='cart_total'>
							 <p class='cart_total_price'>$total_final</p>
						 </td>
				 ...
				 <a href="cart.php" <button class="btn btn-primary" type="submit">Atualizar</button> </a>
